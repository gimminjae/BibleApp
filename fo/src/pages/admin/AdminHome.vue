  ...
  <div class="container" style="margin-top: 20%;">
    ...
    <div class="d-flex justify-content-between" style="white-space: nowrap;">
      <div class="d-flex gap-2">
        <button class="btn btn-outline-secondary">목표 설정</button>
        <button class="btn btn-outline-warning" @click="deptForm">부서 생성</button>
      </div>
    </div>
...
<!--    <div v-for="dept in deptList" :key="dept">-->
<!--      <router-link>{{ dept.deptName }}</router-link>-->
<!--    </div>-->
...
<!--                option-->
<!--              </button>-->
<!--              <ul class="dropdown-menu"> &lt;!&ndash; 관리자 메뉴 &ndash;&gt;-->
<!--                <li>-->
